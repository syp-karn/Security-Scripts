...
* `defender-md-excluder.ps1`: A PowerShell script that recursively adds individual .md files containing legitimate security research content to Microsoft Defender exclusions.